...
const SobreNosotros = () => {
  return (
    <div>
        <> 
        <h1 className='mx-auto text-center w-full h-full text-4xl font-bold p-0 '>
       ¡Nos complace tenerte!
        ...
        <>
        <p className='max-w-screen-lg p-4 mx-auto flex flex-col text-lg md:flex-row'>
        ...
        <img 
             ...
             <p className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg md:flex-row'>
