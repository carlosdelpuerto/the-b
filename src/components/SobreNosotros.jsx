...
const SobreNosotros = () => {
  return (
    <div
    name='nosotros'
    className='w-full h-full bg-gradient-to-r from-gray-500 to-gray-800'>
     
        <h1 className='mx-auto text-center text-4xl text-green-400 font-bold p-0  '>
       ¡Nos complace tenerte!
        </h1>

        <>
        <p className='max-w-screen-lg text-white p-4 mx-auto flex flex-col text-lg md:flex-row'>
        ...
        <h2 className='text-center text-4xl text-green-400 font-bold py-4 '>
           Nuestra Historia
        </h2>
        <img 
                src={Grupo}
             ...
             />
             <p className='mx-auto text-sm text-center text-green-300'>Ronda de tereré a la salida de un exámen 01/10/18</p>
             <p className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg text-white md:flex-row'>
            ...
            <h2 className='mx-auto flex justify-center text-start w-full h-full text-4xl text-green-400 font-bold p-0 '>
                Actualidad
            </h2>
            <p className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg text-white md:flex-row'>
